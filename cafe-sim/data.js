...
const STEPS = [
  ...
  },
  {
    ...
    title: '内装工事費の支払い',
    description:
      'カウンター・照明・壁紙などの内装工事費240万円を現金で支払いました。\n\n' +
      '【問い】お金が減りましたが、総資産は変わるでしょうか？',
    explanation:
      '【会計のポイント】\n' +
  ...
  },
  {
    ...
    description:
      'コーヒー豆（20万円分）と紙コップ等の消耗品（5万円分）の合計25万円分を卸業者から掛けで仕入れました。\n\n' +
  ...
  },
  {
    ...
    explanation:
      ...
      '現在の損益：売上60万円 - 費用（給与30 + 広告10）= 20万円の黒字。\n' +
  ...
  },
  {
    ...
    explanation:
      ...
      '負債の返済はPLに影響しません！\n' +
      '買掛金（商品代）も未払金（備品代）も、どちらも資産の取得に対する後払いです。\n' +
      '資産の取得はPLに影響しないので、その支払い時もPLは動きません。\n\n' +
      '利益剰余金が変わらないことをグラフで確認してください。',
    changes: [
  ...
  },
  {
    ...
    explanation:
      ...
      '収益と費用がちょうど釣り合った状態です。ここからさらに費用が続きます。',
    changes: [
  ...
  },
  {
    ...
    title: '元本返済と利息支払い',
    description:
      '銀行借入金500万円について、今月分の元本10万円の返済と利息5万円の支払い、合計15万円を現金で支払いました。\n\n' +
      '【問い】元本の返済と利息の支払い——どちらがPLに影響するでしょうか？',
    explanation:
      '【会計のポイント】\n' +
      '■ 元本返済（10万円）：現金預金↓・長期借入金↓\n' +
      '→ 資産と負債が同時に減るだけで、PLには影響しません。\n\n' +
      '■ 利息支払い（5万円）：現金預金↓・支払利息（費用）↑\n' +
      '→ お金を借りたコストとして費用計上され、PLの利益を押し下げます。\n\n' +
      '同じ「銀行への支払い」でも、\n' +
      '元本 → BSのみ変動、利息 → BSとPL両方に影響、\n' +
      'というインパクトの違いをグラフで確認しましょう。\n\n' +
      '累計赤字が▲19万円 → ▲24万円に拡大しました。',
    changes: [
      { account: '現金預金',   delta: -15 },
      { account: '長期借入金', delta: -10 },
